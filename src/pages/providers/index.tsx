...
function ProviderListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<ProviderInterface[]>(
    ...
    () =>
      getProviders({
        relations: ['user', 'course.count', 'health_coach.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('health_coach', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                    <Th>health_coach</Th>
                  )}
                  <Th>Actions</Th>
                </Tr>
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('health_coach', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.health_coach}</Td>
                    )}
                    <Td>
